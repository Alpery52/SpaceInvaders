...
/**
 * Personal Space invaders theme to showcase how you can customize the appearance of the game
 */
public class SohaibInvaders implements Theme{
    ...
    public Image playerImage() {
        return new ImageIcon("src\\main\\java\\SpaceInvaders\\Ressurser\\SohaibDefault.png").getImage();
    }

    @Override
    public Image playerImageR() {
        return new ImageIcon("src\\main\\java\\SpaceInvaders\\Ressurser\\SohaibTiltR.png").getImage();
    }

    @Override
    public Image playerImageL() {
        return new ImageIcon("src\\main\\java\\SpaceInvaders\\Ressurser\\SohaibTiltL.png").getImage();
    }

    @Override
    public Image enemyImage() {
        return new ImageIcon("src\\main\\java\\SpaceInvaders\\Ressurser\\pig.png").getImage();
    }
